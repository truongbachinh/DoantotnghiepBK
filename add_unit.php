              ...
              <tbody>
                  ...
                  while($row=mysqli_fetch_array($res))  
                  {
                    ?>
                          ...
                          <td><a href="delete_unit.php?id=<?php echo $row["id"]; ?>">Delete</a>
                        </td>
                          </tr>
...
{   
    $count = 0;
    $res=mysqli_query($link,"select * from exam_for_user where exam='$_POST[examname]'" );
    ...
    {
        mysqli_query($link,"insert into exam_for_user values(NUll,'$_POST[examname]','$_POST[time_do_exam]')");
