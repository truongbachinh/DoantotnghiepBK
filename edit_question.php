...
{
    mysqli_query($link,"update question set question='$_POST[question]',opt1='$_POST[update_opt1]',opt2='$_POST[update_opt2]',opt3='$_POST[update_opt3]',opt4='$_POST[update_opt4]',answer='$_POST[update_answer]' where id=$id");
