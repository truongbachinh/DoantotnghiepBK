...
<tr>
    ...
    <td style="padding-left: 10px">
      <?php
      if(strpos($opt1,'image_question/')!=false)
      {
        ?>
            <img src="<?php echo $opt1; ?>" height="30" width="30">
        <?php
      }
      else
      {
...
<tr>
    ...
    <td style="padding-left: 10px">
      <?php
      if(strpos($opt2,'image_question/')!=false)
      {
        ?>
            <img src="<?php echo $opt2; ?>" height="30" width="30">
        <?php
...
<tr>
    ...
    <td style="padding-left: 10px">
      <?php
      if(strpos($opt3,'image_question/')!=false)
      {
        ?>
            <img src="<?php echo $opt3; ?>" height="30" width="30">
        <?php
...
<tr>
    ...
    <td style="padding-left: 10px">
      <?php
      if(strpos($opt4,'image_question/')!=false)
      {
        ?>
            <img src="<?php echo $opt4; ?>" height="30" width="30">
        <?php
