...
if(isset($_POST["submitl"]))
{
    ...
    if($count>0)
    {
        ...
        mysqli_query($link,"insert into user_registration values(NUll,'$_POST[firstname]','$_POST[lastname]','$_POST[username]','$_POST[password]','$_POST[email]','$_POST[phone]','$_POST[address]'");
        ?>
        <script type="text/javascript">
