...
?>
    ...
    <div class="row" style="margin: 0px; padding:0px; margin-bottom: 50px;">
        ...
        <div class="col-lg-8 col-lg-push-2" style="min-height: 500px; background-color: white;">
            ...
            {
                ?>
            <input type="button" class="btn btn-success form-control" value="<?php echo $row["exam"]; ?>" style="margin-top: 10px; background-color: pink; color: white" onclick="set_exam_type_session(this.value);">
                <?php
